...
input_csv = "brac_title_authors.csv"  # Replace with your input CSV file name
output_authors_csv = "brac_authors_with_ids.csv"
output_papers_csv = "brac_papers_with_ids.csv"
